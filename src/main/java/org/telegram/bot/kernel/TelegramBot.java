...
public class TelegramBot {
    ...
    public TelegramBot(BotConfig config, ChatUpdatesBuilder chatUpdatesBuilder, int apiKey, String apiHash, String deviceModel, String appName, String appVersion, String language) {
        if (config == null) {
    ...
    private void initKernelComm() {
        final long start = System.currentTimeMillis();
        this.kernelComm.init(deviceModel, appName, appVersion, language);
